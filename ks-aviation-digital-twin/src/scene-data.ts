...
export type SceneData = { schema: 'KS_DIGITAL_TWIN_V1'; airport: 'ADB'; entities: Entity[]; groups: { id: string; name: string }[]; source: string; updatedAt?: string; groundPhoto?:GroundPhoto; sharedGround?:GroundMode; groundModes?:{airport:GroundMode;facility:GroundMode} };
...
export const CATALOG: Record<string, { tr: string; en: string; kind: Kind; width:number; length:number; height:number; radius?:number; color?:string; wallStyle?:string }> = {
  ...
  MANIFOLD:{tr:'Vana / manifold',en:'Valve / manifold',kind:'structure',width:1.2,length:2.8,height:1.2,color:'#598897'},
